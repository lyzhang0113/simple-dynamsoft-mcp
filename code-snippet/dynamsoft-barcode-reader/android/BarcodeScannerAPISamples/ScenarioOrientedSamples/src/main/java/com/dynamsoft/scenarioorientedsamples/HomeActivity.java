...
public class HomeActivity extends AppCompatActivity implements HomeItemAdapter.OnHomeItemClickListener {
    ...
    public void onHomeItemClick(@NonNull ModeInfo modeInfo) {
         ...
         * utm_source=samples&package=android
         */
        config.setLicense(
                "DLS2eyJoYW5kc2hha2VDb2RlIjoiMjAwMDAxLTE2NDk4Mjk3OTI2MzUiLCJvcmdhbml6YXRpb25JRCI6IjIwMDAwMSIsInNlc3Npb25QYXNzd29yZCI6IndTcGR6Vm05WDJrcEQ5YUoifQ==");

        // You can use the following code to specify the barcode format. If you are
        // using a template file, the "BarcodeFormat" can also be specified via the
        // template file.
        // config.setBarcodeFormats(EnumBarcodeFormat.BF_ONED |
        // EnumBarcodeFormat.BF_QR_CODE);
        // If you have a customized template file, please put it under
        // "src\main\assets\Templates\" and call the following code.
        // config.setTemplateFilePath("ReadSingleBarcode.json");
        // The following settings will display a scan region on the view. Only the
        // barcode in the scan region can be decoded.
        ...
        // Uncomment the following line if you want the camera to auto-zoom when the
        // barcode is far away.
        // config.setAutoZoomEnabled(false);

        config.setTemplateFile(modeInfo.templateFileInAsset); // modeInfo.templateFileInAsset is one of template file in
                                                              // asset/Templates, null for default template.
