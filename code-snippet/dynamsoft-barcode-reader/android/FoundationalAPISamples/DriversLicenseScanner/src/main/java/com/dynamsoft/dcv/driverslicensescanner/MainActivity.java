...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            // https://www.dynamsoft.com/customer/license/trialLicense?product=cvs&utm_source=samples&package=android
    ...
    private void showParsedText() {
        if (textBeforeParsing != null && !textBeforeParsing.isEmpty()) {
            runOnUiThread(() -> {
                ...
                tvParsedText.setText(
                        "Failed to parse the result. The drivers' information does not exist in the barcode! ");
            });
        }
    }
