...
public class MainActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        // Start capturing when the view will appear. If success, you will receive
        // results in the CapturedResultReceiver.
        mRouter.startCapturing(EnumPresetTemplate.PT_READ_SINGLE_BARCODE, /*
                                                                           * @Nullable CompletionListener
                                                                           * completionHandler =
    ...
    private void initView() {
        ...
        binding.scAutoZoom.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                ...
                // towards the un-decoded barcode zone and zoom-out after the barcode is
                // decoded.
        ...
        binding.tvManuelZoom.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                float indexEnd = binding.sbManuelZoom.getWidth() - binding.sbManuelZoom.getPaddingEnd()
                        + binding.sbManuelZoom.getX();
        ...
        if (mAlertDialog == null) {
            ...
            mAlertDialog = new AlertDialog.Builder(this).setCancelable(true).setPositiveButton("OK", null)
                    .setOnDismissListener(
                            dialog -> mRouter.startCapturing(EnumPresetTemplate.PT_READ_SINGLE_BARCODE, null))
                    .create();
        }
